...
ui <- shinyUI(fluidPage(
  ...
  navbarPage("Menu",
                      ...
                      sidebarLayout(
                        sidebarPanel(
                          fluidRow(
                            column(12,
                                   div(
                                     fluidRow(column(9,h3("Step 1: Enter FTE Details")),column(3,div(class="right-align",br(),actionButton("manpower_info_button", "Info", icon = icon("lightbulb"))))),
                          ...
                          fluidRow(
                            column(12,
                                   div(
                                     fluidRow(column(9,h3(" Step 2: CTC Input")),column(3,div(class="right-align",br(),actionButton("manpower_ctc_info_button", "Info", icon = icon("lightbulb"))))),
                        ...
                        fluidRow(
                          column(9,
                                 fluidRow(column(6,h3("Monitoring Pilferage Fuel Loss")),
                                          column(6, br(), div(class = "right-align", actionButton("pilferage_info_button", "Info", icon = icon("lightbulb"))))
                                 ),
                                 fluidRow(
                                   column(width=6,
             ...
             tabPanel("Idling",
                      fluidRow(column(9,h3("Monitoring Excessive Idling")),column(3,div(class="right-align",br(),actionButton("idling_info_button", "Info", icon = icon("lightbulb"))))),
                      sidebarLayout(
